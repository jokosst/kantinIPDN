...
<div class="content-wrapper">
    ...
    <h1>
     ...
     <div class="row" style="margin-bottom: 0px; padding: 15px;">
      <div class="col-md-4">
        <form method="post" action="{{url('pembelian/masuk')}}" style="margin: 0;">
           @csrf
          <div class="row">
      ...
      <div class="row">
        <div class="col-md-12">
           <div class="box box-primary">
            ...
            <a href="#" data-toggle="modal" data-target="#tambah" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Pembelian Masuk</a>
            </div>
            <div class="box-body">
            <div class="row">
                    ...
                    <tbody>
                      @foreach($pembelians as $p)
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('{{url('pembelian/masuk/hapus/'.$p->id)}}')"><i class="fa fa-trash"></i> Hapus</button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Tambah Pembelian Masuk</h5>
          </div>
          <form method="POST" action="{{url('pembelian/masuk/tambah')}}">
            @csrf
            <div class="modal-body row">
              ...
              <div class="form-group col-md-12">
                ...
                <select name="id_stok" class="form-control select2" required>
                  ...
                  @endphp
                  <option value="{{$i->id_item}}">{{$i->nama}} [{{$satuan->nama_satuan}}]</option>
                  @endforeach
                </select>
              </div>
