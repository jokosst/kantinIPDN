...
<div class="content-wrapper">
    ...
    <h1>
     ...
     <div class="row" style="margin-bottom: 0px; padding: 15px;">
      <div class="col-md-6">
        <form method="post" action="{{url('laporan/stok')}}" style="margin: 0;">
           @csrf
          <div class="row">
                ...
                <table class="table table-bordered table-striped">
                        ...
                        <tfoot>
                                <tr>
                                        ...
                                        <th colspan="2">Rp. {{number_format($transaksi->sum(function($item) { return $item->harga_beli * $item->jumlah; }))}}</th>
                                </tr>
                        </tfoot>
                </table>
                </div>
...
function exportToXLSX() {
  ...
  function exportToPDF() {
      ...
      html2pdf().from(element).save('stok.pdf');
  }
</script>
@endsection